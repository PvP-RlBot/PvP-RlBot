...
class Vector3:
    ...
    def __init__(self, x: Union[float, 'Vector3', 'game_data_struct.Vector3']=0, y: float=0, z: float=0):
        """
    ...
    def __truediv__(self, scale: float) -> 'Vector3':
        scale = 1 / float(scale)
        return self * scale
    ...
    def rescale(self, new_len: float) -> 'Vector3':
    ...
    def ang_to(self, ideal: 'Vector3') -> float:
